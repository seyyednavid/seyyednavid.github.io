...
image: "/img/posts/advanced-rag-system-title.png"
...
![Baseline RAG evaluation results](/img/posts/advanced-rag-baseline-evaluation.jpg)
...
![Advanced RAG evaluation results](/img/posts/advanced-rag-advanced-evaluation.jpg)
...
![Hugging Face embeddings in 2D](/img/posts/advanced-rag-huggingface-embeddings-2d.png)

![Hugging Face embeddings in 3D](/img/posts/advanced-rag-huggingface-embeddings-3d.png)

### OpenAI Embeddings

![OpenAI embeddings in 2D](/img/posts/advanced-rag-openai-embeddings-2d.png)

![OpenAI embeddings in 3D](/img/posts/advanced-rag-openai-embeddings-3d.png)
...
![Advanced RAG application interface](/img/posts/advanced-rag-application.jpg)
